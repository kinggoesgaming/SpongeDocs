...
Plugins using the SpongeAPI have the option to use one or more configuration files. Configuration files allow plugins
...
The SpongeAPI offers the use of the ``@DefaultConfig`` annotation on a field or setter method with the type ``Path``
